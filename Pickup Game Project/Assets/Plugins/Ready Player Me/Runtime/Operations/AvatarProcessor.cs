...
namespace ReadyPlayerMe
{
    public class AvatarProcessor : IOperation<AvatarContext>
    {
        ...
        // Animator Controller
         private const string ANIMATION_CONTROLLER_NAME = "Avatar Animator";
        ...
        private void SetupAnimator(GameObject avatar, OutfitGender gender)
        {
            ...
            var animatorController = Resources.Load<RuntimeAnimatorController>(ANIMATION_CONTROLLER_NAME);
